...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="logo">
						 <a href="index-2.html">
							<img src="images/logos/logo-big.png" alt="">
						 </a>
					</div>
				</div><!-- logo col end -->
							...
							<ul class="nav navbar-nav">
								<li class="dropdown active">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li class="active"><a href="index-4.html">Home 3</a></li>
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li class="dropdown-submenu">
											...
											<ul class="dropdown-menu">
												...
												<li><a href="single-post2.html">Single Post 2 (Video)</a></li>
	...
	<section class="featured-post-area no-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-xs-12 pad-r">
				...
				<div class="col-md-4 col-xs-12 pad-l">
					<div class="row">
						<div class="col-sm-12">
						...
						<div class="col-sm-12">
							<div class="post-overaly-style text-center clearfix">
								<div class="post-thumb">
									<a href="#"><img class="img-responsive" src="images/news/tech/game1.jpg" alt="" /></a>
								</div>
								<div class="post-content">
